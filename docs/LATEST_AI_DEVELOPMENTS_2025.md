...
- **参数量**：o1系列参数量未公开（推测70B-175B范围）
- **训练数据**：未公开具体token数
- **基准分数**：
  - MATH基准：o1达到~90%准确率（相比GPT-4的~50%显著提升）
  - HumanEval：o1达到~85%准确率
  - GSM8K：o1达到~95%准确率
...
- **参数量**：未公开（推测与o1相当，70B-175B范围）
- **训练数据**：未公开具体token数
- **基准分数**：
  - 数学任务：在MATH、GSM8K等基准上表现优异
  - 编码任务：在HumanEval等基准上表现优异
...
- **模型规模**：未公开（推测为大规模多模态模型）
- **训练数据**：未公开具体token数和视频数据量
- **生成能力**：
  - 视频长度：支持最长60秒视频生成
  - 分辨率：支持多种分辨率（具体未公开）
  - 生成质量：在视频质量评估中表现优异
