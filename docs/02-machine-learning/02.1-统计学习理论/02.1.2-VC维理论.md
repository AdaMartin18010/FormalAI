...
- [02.1.2 VC 维理论 / VC Dimension Theory / VC-Dimension-Theorie / Théorie de la dimension VC](#0212-vc-维理论--vc-dimension-theory--vc-dimension-theorie--théorie-de-la-dimension-vc)
  - [概述 / Overview](#概述--overview)
  - [目录 / Table of Contents](#目录--table-of-contents)
  - [1. VC 维定义 / VC Dimension Definition](#1-vc-维定义--vc-dimension-definition)
    - [1.1 基本定义 / Basic Definition](#11-基本定义--basic-definition)
    - [1.2 粉碎函数 / Shattering Function](#12-粉碎函数--shattering-function)
    - [1.3 VC 维的等价定义 / Equivalent Definition](#13-vc-维的等价定义--equivalent-definition)
    - [1.4 增长函数 / Growth Function](#14-增长函数--growth-function)
  - [2. VC 维性质 / VC Dimension Properties](#2-vc-维性质--vc-dimension-properties)
    - [2.1 单调性 / Monotonicity](#21-单调性--monotonicity)
    - [2.2 并集性质 / Union Property](#22-并集性质--union-property)
    - [2.3 乘积性质 / Product Property](#23-乘积性质--product-property)
    - [2.4 组合性质 / Composition Property](#24-组合性质--composition-property)
  - [3. VC 维计算 / VC Dimension Computation](#3-vc-维计算--vc-dimension-computation)
    - [3.1 常见假设类的 VC 维 / VC Dimension of Common Hypothesis Classes](#31-常见假设类的-vc-维--vc-dimension-of-common-hypothesis-classes)
    - [3.2 VC 维计算算法 / VC Dimension Computation Algorithms](#32-vc-维计算算法--vc-dimension-computation-algorithms)
    - [3.3 VC 维下界 / VC Dimension Lower Bounds](#33-vc-维下界--vc-dimension-lower-bounds)
  - [4. VC 维界 / VC Dimension Bounds](#4-vc-维界--vc-dimension-bounds)
    - [4.1 Sauer 引理 / Sauer's Lemma](#41-sauer-引理--sauers-lemma)
    - [4.2 VC 维与泛化误差 / VC Dimension and Generalization Error](#42-vc-维与泛化误差--vc-dimension-and-generalization-error)
    - [4.3 结构风险最小化 / Structural Risk Minimization](#43-结构风险最小化--structural-risk-minimization)
  - [5. 应用 / Applications](#5-应用--applications)
    - [5.1 模型选择 / Model Selection](#51-模型选择--model-selection)
    - [5.2 正则化 / Regularization](#52-正则化--regularization)
    - [5.3 特征选择 / Feature Selection](#53-特征选择--feature-selection)
  - [代码示例 / Code Examples](#代码示例--code-examples)
    - [Rust 实现：VC 维计算](#rust-实现vc-维计算)
    - [Haskell 实现：VC 维理论](#haskell-实现vc-维理论)
  - [参考文献 / References](#参考文献--references)
  - [2024/2025 最新进展 / Latest Updates](#20242025-最新进展--latest-updates)
    - [VC 维理论的前沿发展](#vc-维理论的前沿发展)
      - [1. 深度神经网络的 VC 维分析](#1-深度神经网络的-vc-维分析)
      - [2. 注意力机制的 VC 维分析](#2-注意力机制的-vc-维分析)
      - [3. 联邦学习中的 VC 维](#3-联邦学习中的-vc-维)
      - [4. 量子机器学习中的 VC 维](#4-量子机器学习中的-vc-维)
    - [2025 年最新理论突破](#2025-年最新理论突破)
      - [1. 自适应 VC 维](#1-自适应-vc-维)
      - [2. 因果 VC 维](#2-因果-vc-维)
      - [3. 多模态 VC 维](#3-多模态-vc-维)
    - [形式化验证与 AI 安全](#形式化验证与-ai-安全)
      - [1. 鲁棒性 VC 维](#1-鲁棒性-vc-维)
      - [2. 隐私保护 VC 维](#2-隐私保护-vc-维)
    - [Lean 4 形式化实现](#lean-4-形式化实现)
    - [实际应用案例](#实际应用案例)
      - [1. 大语言模型复杂度分析](#1-大语言模型复杂度分析)
      - [2. 计算机视觉模型分析](#2-计算机视觉模型分析)
      - [3. 多模态模型复杂度](#3-多模态模型复杂度)
...
**权威引用**：[AUTHORITY_REFERENCE_INDEX](../../AUTHORITY_REFERENCE_INDEX.md) [SLT-03][SLT-04] — Vapnik-Chervonenkis；与 Mohri et al. (2018) Ch.6 定义 6.1 一致。
