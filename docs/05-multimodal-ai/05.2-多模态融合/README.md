...
1. **统一多模态架构**
   - **Sora**（2024年）：文生视频技术展示了统一多模态架构的能力，实现了文本到视频的跨模态生成
   - **Gemini 2.5**（2024-2025年）：强大的多模态能力，支持跨模态推理和融合
   - **DeepSeek-V3**（2024年12月）：在数学、编码和中文任务上表现卓越，支持多模态输入
   - **技术影响**：统一多模态架构推动了多模态融合技术的发展

2. **跨模态对齐优化**
   - **视觉-语言对齐**：多模态模型在视觉-语言对齐方面取得突破
