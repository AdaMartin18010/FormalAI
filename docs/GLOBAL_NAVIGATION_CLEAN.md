# 全局导航系统（精简版） / Global Navigation System (Clean Version)
...
本文档提供FormalAI项目的精简全局导航系统，专注于核心主题内容，移除所有进度报告和临时文档的引用。
...
- [0.5 Markdown格式化配置说明](./0-总览与导航/0.5-Markdown格式化配置说明.md)
...
- [17.3 集体智能](./17-social-ai/17.3-集体智能/README.md)
- [17.4 AI社会影响](./17-social-ai/17.4-AI社会影响/README.md)
...
- [20.2 自由意志](./20-ai-philosophy-advanced/20.2-自由意志/README.md)
- [20.3 机器意识](./20-ai-philosophy-advanced/20.3-机器意识/README.md)
- [20.4 AI存在论](./20-ai-philosophy-advanced/20.4-AI存在论/README.md)
...
- [2024-2025年最新AI技术发展总结](./LATEST_AI_DEVELOPMENTS_2025.md) ⭐ **核心参考**
- [最新发展跟踪](./LATEST_DEVELOPMENTS_TRACKER.md)

### 2.3 标准与模板

- [模板：模型卡](./TEMPLATES_MODEL_CARD.md)
- [模板：评测卡](./TEMPLATES_EVAL_CARD.md)
- [标准检查清单](./STANDARDS_CHECKLISTS.md)
